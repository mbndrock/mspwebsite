        ...
        <section className="home6-pricing-section s-padding">
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="pricing-t-s6 pricing-t-s1">
                            <div className="pt-header">
                                <div className="icon">
                                    <img
                                        src={require(`../../assets/images/feature-icons/development-icon2.svg`).default}
                                        alt=""
                                    />
                                </div>
                                <div className="price">
                    ...
                    <span className="icon"
                    ><img
                        src={require(`../../assets/images/feature-icons/check-price.svg`).default}
                        alt=""
                    /></span>
                    ...
                    /></span>
                            ...
                            <div className="pt-footer">
                                <a href="/pricing" className="pt-btn btn btn-s6">Buy Now</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
