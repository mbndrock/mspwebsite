                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="video-thumb">
                            <img src={require(`../../assets/images/thumbs/video-sec-thumb.webp`)} alt=""/>
                            <a onClick={()=>setVideoModal(!videoModal)}
                                href="#nolink"
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6">
                        <div className="funfact-s1">
                            <div className="icon">
                                <img src={require(`../../assets/images/feature-icons/projects.svg`).default} alt=""/>
                            </div>
                            <div className="content">
                                <h4>
                  <span className="counter-item">574</span
                  ><span className="c-sfix">+</span>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="funfact-s1">
                            ...
                            <div className="content">
                                <h4>
                  <span className="counter-item">18</span
                  ><span className="c-sfix">+</span>
                                </h4>
                                <p>Glorious Years</p>
                            </div>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="funfact-s1">
                            ...
                            <div className="content">
                                <h4>
                  <span className="counter-item">200</span
                  ><span className="c-sfix">+</span>
                                </h4>
                                <p>Active Clients</p>
                            </div>
